...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhhbnR5YXJ6YXJoZWluIiwiYSI6ImNqem1sMnZzYjE2eGgzb29hcTB3a2huMnMifQ.A6-yL94BTtsnMG0WuPq6Ig';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/thantyarzarhein/cjzmlhh2k0wrn1cp6m2aq9zrv',
    scrollZoom: false //   center: [95.956, 21.9162],
    //   zoom: 10,
    //   interactive: false
...
var logOutBtn = document.querySelector('.nav__el--logout'); // DELICATION
